...
public class Cineminha{
    ...
    public static void main(String[] args){
        ...
        //Introdução:
        System.out.println("Seja muito bem vindo ao Cineminha");
        ...
        System.out.println("Em qual sala você deseja assistir? ?\n1.)Alpha\n2.)Beta");
        ...
        if (opcao == 1) {
                ...
                if (assentos < 23) {
                    System.out.println("alguém é portador de alguma deficiência ? [1 = sim / 2 = não]");
                    int r = sc.nextInt();
                    switch (r) {
                        case 1:
                        if (assentos < 12){
                       ...
                       case 2:
                        ...
                        switch (fileiras) {
                            ...
                            System.out.println(nome+", seus ingressos foram comprados com sucesso. Aproveite a melhor pipoca de todos os tempos e tenha um bom filme.");
                            break;
                            case 2:
